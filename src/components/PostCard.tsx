...
import getPosts, { createComment, deletePost } from "@/actions/posts.actions";
...
import { toggleLike } from "@/actions/posts.actions";
    ...
    <Card className="overflow-hidden">
      <CardContent className="p-4 sm:p-6">
        <div className="space-y-4">
          ...
          <div className="flex items-center pt02 space-x-4">
            {user ? (
              <Button
                variant="ghost"
                size="sm"
            ...
            >
              <MessageCircleIcon
                className={`size-5 ${showComments ? "fill-blue-500" : ""}`}
              />
